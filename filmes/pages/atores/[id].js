...
const Detalhes = ({ator, imagens, filmes, series}) => {
  return (
      <Pagina titulo={ator.name}>
       ...
       <Row>
          <Col md={3}>
            <Card.Img  src={('https://image.tmdb.org/t/p/w500/'+ ator.profile_path)} variant="top"/>
          </Col>
